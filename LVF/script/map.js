...
let map = L.map("map").setView([45.787, 3.1127], 6);
...
markers.push(
  new Marker([47.2769, -2.2453], "Saint-Nazaire", "Boutique", map, "magasin")
);
markers.push(
  new Marker([43.2186, 5.5504], "Cassis", "Boutique", map, "magasin")
);
markers.push(
  new Marker([43.6422, 5.0489], "Salon de Provence", "Boutique", map, "magasin")
);
markers.push(new Marker([44.5348, 3.4911], "Mende", "Usine", map, "usine"));
markers.push(
  new Marker([43.6086, 3.8865], "Montpellier", "Siège social", map, "siege")
);
