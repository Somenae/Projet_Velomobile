...
export default class footer extends ManageDom {
  constructor() {
    ...
    render(){
        ...
        const divContainer = this.createMarkup("div", "", footer, [{"class":"div-container"}])
        ...
        const nav = this.createMarkup("nav", "", divContainer, [{"class":"ul-box"}]);
        const ul = this.createMarkup("ul", "", nav);
        let divSocialTab = this.createMarkup("div", "",divContainer, [{"class":"div-social-tab"}]);
        let i = 0;
        let liTab = [];
        let aTab1 = [];
        let aTab2 = [];
        ...
        i = 0;
        while(i<4){
            aTab2[i] = this.createMarkup("a", "", divSocialTab);
